...
import com.example.gleb.vkmessager.profile.VkProfile;
...
//            intent.putExtra(Content.REQUEST, request.registerObject());
//            Log.d(TAG, "startApiCall");
//            startActivity(intent);

            Intent intent = new Intent(getActivity(), VkProfile.class);
            startActivity(intent);
        }
